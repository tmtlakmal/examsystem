...
<table>
<tr>
        <td width="120"><a href="http://localhost/alevelSystem/index.php/Students/index"><?php echo ('Register Students'); ?> </td>
        <td width="120"><a href="http://localhost/alevelSystem/index.php/Students/index"><?php echo ('Enter Marks'); ?> </td>
        <td width="120"><a href="http://localhost/alevelSystem/index.php/Exam_centers/index"><?php echo ('Examination Centers'); ?> </td>
        <td width="120"><a href="http://localhost/alevelSystem/index.php/Subjects/index"><?php echo ('Subject Details'); ?> </td>
        <td width="120"><a href="http://localhost/alevelSystem/index.php/Students/index"><?php echo ('Time Table'); ?> </td>
